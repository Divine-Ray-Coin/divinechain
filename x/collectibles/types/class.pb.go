...
// source: divine/collectibles/v1/class.proto
...
// Class defines the Class message.
type Class struct {
...
func (*Class) Descriptor() ([]byte, []int) {
	return fileDescriptor_cc554c686cc26f96, []int{0}
}
...
func init() {
	proto.RegisterType((*Class)(nil), "divine.collectibles.v1.Class")
}

func init() {
	proto.RegisterFile("divine/collectibles/v1/class.proto", fileDescriptor_cc554c686cc26f96)
}

var fileDescriptor_cc554c686cc26f96 = []byte{
	...
	,
}
...
func (m *Class) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Admin) > 0 {
		i -= len(m.Admin)
		copy(dAtA[i:], m.Admin)
		i = encodeVarintClass(dAtA, i, uint64(len(m.Admin)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Uri) > 0 {
